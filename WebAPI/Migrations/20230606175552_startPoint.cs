...
namespace WebAPI.Migrations
{
    public partial class startPoint : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "Id", "BrandId", "CarName", "ColorId", "DailyPrice", "Description", "ModelYear" },
                values: new object[,]
                {
                    { 1, 1, "Car 1", 1, 200m, "desc", 1996 },
                    { 2, 2, "Car 2", 2, 1225m, "desc", 2005 },
                    { 3, 3, "Car 3", 3, 3200m, "desc", 2020 },
                    { 4, 4, "Car 4", 4, 150m, "desc", 1992 },
                    { 5, 1, "Car 5", 3, 800m, "desc", 2003 }
                });
